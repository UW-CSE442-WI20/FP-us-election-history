...
function tooltipHtml(n, d){ /* function to create html content string in tooltip div. */
    return "<h4>"+n+"</h4><table>"+
        ...
        "<tr><td>Democrat</td><td>"+(d.dem)+"</td></tr>"+
        "<tr><td>Republican</td><td>"+(d.rep)+"</td></tr>"+
    ...
    if (voteData.has(currentYear)) {
        ...
        "WI", "MO", "AR", "OK", "KS", "LA", "VA"]
            .forEach(function(d){
                ...
                if(party == "democrat") {
                    sampleData[d] = {dem:winPercent, rep:losePercent, other:otherPercent, color:d3.interpolate("#FFFFFF", "#0015BC")(winningPercent)};
                } else {
                    sampleData[d] = {dem:losePercent, rep:winPercent, other:otherPercent, color:d3.interpolate("#FFFFFF", "#E9141D")(winningPercent)};
                }
            });
